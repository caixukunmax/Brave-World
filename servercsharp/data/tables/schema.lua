...
local enums =
{
    ...
    ---@class common.EAttr @统一属性枚举（玩家/怪物通用）
     ---@field public HP integer @生命值
     ---@field public MAX_HP integer @最大生命
     ---@field public MP integer @魔法值
     ---@field public MAX_MP integer @最大魔法
     ---@field public AGILITY integer @敏捷
     ---@field public PATK integer @物攻
     ---@field public MATK integer @魔攻
     ---@field public PDEF integer @物防
     ---@field public MDEF integer @魔防
     ---@field public MOVE_SPEED integer @移动速度
    ['common.EAttr'] = {   HP=1,  MAX_HP=2,  MP=3,  MAX_MP=4,  AGILITY=5,  PATK=6,  MATK=7,  PDEF=8,  MDEF=9,  MOVE_SPEED=10,  };
...
local beans = {}
    ...
    ---@class common.PlayerAttrCfg 
     ...
     ---@field public move_speed integer @移动速度(ms)
        local class = {
            { name='id', type='integer'},
            { name='hp', type='integer'},
            { name='mp', type='integer'},
